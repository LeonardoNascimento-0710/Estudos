...
Partial Class FrmRetaguarda
    ...
    Private Sub InitializeComponent()
        ...
        Panel1 = New Panel()
        PicProds = New PictureBox()
        BtnSelecionarImagem = New Button()
        CmbTipoEtq = New ComboBox()
        Label1 = New Label()
        ...
        CType(PicProds, ComponentModel.ISupportInitialize).BeginInit()
        ...
        TabPage1.Controls.Add(BtnSelecionarImagem)
        TabPage1.Controls.Add(CmbTipoEtq)
        TabPage1.Controls.Add(Label1)
        TabPage1.Controls.Add(BtnLimpar)
        TabPage1.Controls.Add(CmbGrupos)
        TabPage1.Controls.Add(CmbTipoFiltro)
        ...
        Panel1.Controls.Add(PicProds)
        Panel1.Location = New Point(562, 34)
        Panel1.Name = "Panel1"
        Panel1.Size = New Size(145, 145)
        Panel1.TabIndex = 30
        ' 
        ' PicProds
        ' 
        PicProds.ErrorImage = Nothing
        PicProds.Image = My.Resources.Resources.Foto
        PicProds.InitialImage = My.Resources.Resources.Foto
        PicProds.Location = New Point(16, 14)
        PicProds.Name = "PicProds"
        PicProds.Size = New Size(115, 116)
        PicProds.SizeMode = PictureBoxSizeMode.StretchImage
        PicProds.TabIndex = 28
        PicProds.TabStop = False
        ' 
        ' BtnSelecionarImagem
        ' 
        BtnSelecionarImagem.BackgroundImage = My.Resources.Resources.Foto
        BtnSelecionarImagem.BackgroundImageLayout = ImageLayout.Zoom
        BtnSelecionarImagem.Location = New Point(618, 185)
        BtnSelecionarImagem.Name = "BtnSelecionarImagem"
        BtnSelecionarImagem.Size = New Size(32, 27)
        BtnSelecionarImagem.TabIndex = 29
        BtnSelecionarImagem.UseVisualStyleBackColor = True
        ' 
        ' CmbTipoEtq
        ' 
        CmbTipoEtq.AllowDrop = True
        ...
        CmbGrupos.Location = New Point(356, 39)
        ...
        CmbFiltro.Items.AddRange(New Object() {"Grupo", "Custo", "Venda", "Tipo estoque"})
        ...
        LblGrpProdutos.Location = New Point(356, 21)
        ...
        CmbProdutos.Size = New Size(326, 23)
        ...
        DgvProdutos.Size = New Size(683, 283)
        ...
        LblCodProd.Location = New Point(24, 64)
        ...
        LblNomeProd.Location = New Point(24, 21)
        ...
        TbEstoque.Size = New Size(739, 598)
        ...
        TbRelatorios.Size = New Size(739, 598)
        ...
        CType(PicProds, ComponentModel.ISupportInitialize).EndInit()
    ...
    Friend WithEvents CmbTipoEtq As ComboBox
